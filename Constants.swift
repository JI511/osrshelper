...
class Constants {
    ...
    static let skillPrimaryColors: [UIColor] = [UIColor.blue, UIColor.red, Constants.tan, UIColor.purple, UIColor.brown, Constants.lightBlue, UIColor.green, UIColor.orange, Constants.lightBlue, Constants.teal, UIColor.green, UIColor.white, Constants.tan, UIColor.white, UIColor.gray, UIColor.white, UIColor.green, UIColor.white, UIColor.black, UIColor.gray, UIColor.green, UIColor.purple, Constants.tan]
    
    static let skillSecondaryColors: [UIColor] = [UIColor.red, UIColor.yellow, UIColor.yellow, UIColor.red, UIColor.yellow, UIColor.white, Constants.lightGreen, UIColor.yellow, UIColor.yellow, UIColor.yellow, UIColor.yellow, UIColor.red, UIColor.brown, UIColor.blue, Constants.lightBlue, UIColor.yellow, UIColor.red, UIColor.yellow, UIColor.red, UIColor.black, UIColor.green, UIColor.black, UIColor.green]
